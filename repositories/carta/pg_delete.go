...
func Pg_Delete(idbusiness int, idcarta int) error {
	...
	_, error_carta := tx.Exec(context.TODO(), query_carta, idbusiness, idcarta)
	if error_carta != nil {
	...
	_, error_element := tx.Exec(context.TODO(), query_element, idbusiness, idcarta)
	...
	_, error_listschedulerange := tx.Exec(context.TODO(), query_listschedulerange, idbusiness, idcarta)
	...
	_, error_schedule := tx.Exec(context.TODO(), query_schedulerange, idbusiness, idcarta)
