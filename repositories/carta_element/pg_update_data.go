...
func Pg_Update_Data(element models.Pg_Element, idbusiness int) error {
	...
	q := "UPDATE Element SET isexported=false,price=$1,description=$2,typemoney=$3, updateddate=$4,idcategory=$5 FROM Category WHERE idelement=$6 AND Category.idbusiness=$7"
